...
class DominoExtractor:
    ...
    def extract_dominoes(self, image: np.ndarray) -> np.ndarray:
        ...
        threshold_percentage = 0.50 # might need to be changed
...
if __name__ == "__main__":
    extractor = DominoExtractor("domino_config7.pickle")
    image = cv.imread("../../antrenare_board/1_20.jpg")
    # extractor.extract_dominoes(image)
    extractor.extract_domino(image, ["3B", "3C"])
