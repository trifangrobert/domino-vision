...
class Game:
    def __init__(self, game_path: str, game_index: int, board_config: str = 'board_config9.pickle', extract_domino_config: str = 'extract_domino_config8.pickle', clean_domino_config: str = 'clean_domino_config3.pickle') -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', "--board_config", type=str, default='board_config9.pickle', help='Load extract board config file')
    parser.add_argument('-d', "--extract_domino_config", type=str, default='extract_domino_config8.pickle', help='Load extract dominoes config file')
    parser.add_argument('-c', "--clean_domino_config", type=str, default='clean_domino_config3.pickle', help='Load clean domino config file')
